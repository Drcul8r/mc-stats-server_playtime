...
#Function
def season_old(z,player_uuid):
      path = "stats"+str(z)+"/"+player_uuid+".json"
      if z != 3:
...
while a == 1:
      ...
      print("")
      for z in range(1,9):
            total_playtime += season_old(z,player_uuid)
      for z in range(9,12):
            total_playtime += season_new(z,player_uuid)
      print("\nYour total playtime is:",total_playtime,"\n")